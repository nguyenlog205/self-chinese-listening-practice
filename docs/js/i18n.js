...
const translations = {
  ...
  "feature3.title": { vi: "Luyện nghe qua YouTube", en: "YouTube listening", zh: "YouTube 听力练习",
    "zh-TW": "YouTube 聽力練習" },
  "feature3.desc": {
    vi: "Dán một link video tiếng Trung, hệ thống tự tách câu và hiện transcript song song, tự cuộn theo đúng câu đang phát. Bật phụ đề ngay trên video, tuỳ chọn tự dừng ở cuối mỗi câu để luyện kỹ hơn.",
    en: "Paste a Chinese video link and get a live transcript that scrolls in sync with playback. Toggle captions right on the video, and optionally pause at the end of every sentence for deeper practice.",
    zh: "粘贴一个中文视频链接，系统自动拆分句子，字幕列表随播放进度同步滚动。可在视频上直接显示字幕，也可以设置逐句自动暂停，方便精听。",
    "zh-TW": "粘貼一個中文視頻鏈接，系統自動拆分句子，字幕列表隨播放進度同步滾動。可在視頻上直接顯示字幕，也可以設置逐句自動暫停，方便精聽。",
  },
