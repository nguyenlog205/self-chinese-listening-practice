...
const translations = {
  ...
  "hero.ctaFeatures": { vi: "Xem tính năng", en: "See features", zh: "查看功能",
    "zh-TW": "查看功能" },
  "hero.meta1": { vi: "✓ Windows & Linux (Fedora)", en: "✓ Windows & Linux (Fedora)", zh: "✓ Windows & Linux (Fedora)",
    "zh-TW": "✓ Windows & Linux (Fedora)" },
  "hero.meta2": {
  ...
  "download.ctaNote": {
    vi: "File cài đặt cho cả Linux và Windows đều nằm trong thư mục này.",
    en: "Installers for both Linux and Windows are in this folder.",
    zh: "Linux 和 Windows 的安装文件都在这个文件夹里。",
    "zh-TW": "Linux 和 Windows 的安裝文件都在這個文件夾裡。",
  },
  "download.linux.desc": {
  ...
  "download.win.desc": {
    vi: "Tải file <code>ListeningPractice Setup 0.1.0.exe</code> từ Google Drive.",
    en: "Download the <code>ListeningPractice Setup 0.1.0.exe</code> file from Google Drive.",
    zh: "从 Google Drive 下载 <code>ListeningPractice Setup 0.1.0.exe</code> 文件。",
    "zh-TW": "從 Google Drive 下載 <code>ListeningPractice Setup 0.1.0.exe</code> 文件。",
  },
  "download.win.step1": {
    vi: "Double-click file .exe vừa tải để chạy trình cài đặt",
    en: "Double-click the downloaded .exe file to run the installer",
    zh: "双击下载的 .exe 文件运行安装程序",
    "zh-TW": "雙擊下載的 .exe 文件運行安裝程序",
  },
  "download.win.step2": {
    vi: 'Mở "ListeningPractice" từ Start Menu',
    en: 'Open "ListeningPractice" from the Start Menu',
    zh: "从开始菜单打开「ListeningPractice」",
    "zh-TW": "從開始菜單打開「ListeningPractice」",
  },
  "download.win.note": {
    vi: "Cần cài sẵn Python 3.10+ và ffmpeg trong PATH.",
    en: "Requires Python 3.10+ and ffmpeg already installed in your PATH.",
    zh: "需要预先安装 Python 3.10+ 和 ffmpeg 并加入 PATH。",
    "zh-TW": "需要預先安裝 Python 3.10+ 和 ffmpeg 並加入 PATH。",
  },
