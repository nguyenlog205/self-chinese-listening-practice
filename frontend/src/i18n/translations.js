...
export const translations = {
  ...
  "hsk.group.vocab.title": { vi: "Học tập từ vựng", en: "Vocabulary practice", zh: "词汇学习",
    "zh-TW": "詞彙學習" },
  "hsk.group.vocab.desc": {
    vi: "Ôn luyện từ vựng theo cấp độ: học từ mới, luyện nghe và kiểm tra lại nghĩa.",
    en: "Practice vocabulary by level: learn new words, listen and quiz yourself on meaning.",
    zh: "按级别练习词汇：学习生词、听力练习并自测词义。",
    "zh-TW": "按級別練習詞彙：學習生詞、聽力練習並自測詞義。",
  },
  "hsk.group.grammar.title": { vi: "Học tập ngữ pháp", en: "Grammar practice", zh: "语法学习",
    "zh-TW": "語法學習" },
  "hsk.group.grammar.desc": {
    vi: "Học các cấu trúc ngữ pháp theo cấp độ HSK, kèm ví dụ minh họa.",
    en: "Learn grammar structures by HSK level, with example sentences.",
    zh: "按 HSK 级别学习语法结构，并配有例句。",
    "zh-TW": "按 HSK 級別學習語法結構，並配有例句。",
  },
  "hsk.group.reading.title": { vi: "Học tập đọc hiểu", en: "Reading practice", zh: "阅读学习",
    "zh-TW": "閱讀學習" },
  "hsk.group.reading.desc": {
    vi: "Đọc các đoạn văn mẫu theo cấp độ, kèm pinyin và bản dịch.",
    en: "Read sample passages by level, with pinyin and translation.",
    zh: "按级别阅读示例文章，配有拼音和翻译。",
    "zh-TW": "按級別閱讀示例文章，配有拼音和翻譯。",
  },
  ...
  "hsk.reading.noFilterResults": {
    vi: "Không có bài nào khớp bộ lọc.",
    en: "No passages match this filter.",
    zh: "没有符合筛选条件的文章。",
    "zh-TW": "沒有符合篩選條件的文章。",
  },
  "hsk.reading.progress": { vi: "Đã học", en: "Learned", zh: "已学",
    "zh-TW": "已學" },
  "hsk.reading.learned": { vi: "✓ Đã học", en: "✓ Learned", zh: "✓ 已学",
    "zh-TW": "✓ 已學" },
  "hsk.reading.markLearned": { vi: "Đánh dấu đã học", en: "Mark learned", zh: "标记已学",
    "zh-TW": "標記已學" },
  "hsk.reading.filter.all": { vi: "Tất cả", en: "All", zh: "全部",
    "zh-TW": "全部" },
  "hsk.reading.filter.unlearned": { vi: "Chưa học", en: "Not learned", zh: "未学",
    "zh-TW": "未學" },
  "hsk.reading.filter.learned": { vi: "Đã học", en: "Learned", zh: "已学",
    "zh-TW": "已學" },
  ...
  "listening.youtube.dictationMode": { vi: "Chế độ chính tả", en: "Dictation mode", zh: "听写模式",
    "zh-TW": "聽寫模式" },
  "listening.youtube.showTranscript": { vi: "Hiện transcript", en: "Show transcript", zh: "显示文本列表",
    "zh-TW": "顯示文本列表" },
  "listening.youtube.showCaption": { vi: "Phụ đề trên video", en: "Caption on video", zh: "视频字幕",
    "zh-TW": "視頻字幕" },
  "listening.youtube.autoStopSentence": { vi: "Dừng ở cuối câu", en: "Stop at end of sentence", zh: "句末自动暂停",
    "zh-TW": "句末自動暫停" },
  ...
  "personal.grammarKnown": { vi: "Ngữ pháp đã biết", en: "Grammar known", zh: "已掌握语法",
    "zh-TW": "已掌握語法" },
  "personal.readingLearned": { vi: "Bài đọc đã học", en: "Passages read", zh: "已学阅读",
    "zh-TW": "已學閱讀" },
  "personal.vocabLabel": { vi: "Từ vựng", en: "Vocabulary", zh: "词汇",
    "zh-TW": "詞彙" },
  "personal.grammarLabel": { vi: "Ngữ pháp", en: "Grammar", zh: "语法",
    "zh-TW": "語法" },
  "personal.readingLabel": { vi: "Đọc hiểu", en: "Reading", zh: "阅读",
    "zh-TW": "閱讀" },
